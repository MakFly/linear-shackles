          ...
          {selectedIssue && (
            <>
              ...
              <div className="mt-6 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {selectedIssue.assignees.map((assignee) => (
                          <div
                            key={assignee}
                            className="flex items-center gap-2 bg-secondary px-2 py-1 rounded-full text-sm"
                          >
                ...
                {/* Relationships */}
                {selectedIssue.relationships &&
                  selectedIssue.relationships.length > 0 && (
                    <div>
                      <label className="text-xs text-muted-foreground uppercase tracking-wider">
                        Relations
                      </label>
                      <div className="mt-2 space-y-2">
                        {selectedIssue.relationships.map((rel) => {
                          const relatedIssue = allIssues.find(
                            (i) => i.id === rel.targetIssueId,
                          )
                          return (
                            <div
                              key={rel.id}
