...
// Skip migrations since db:push already handled schema
// If you need to run migrations, use drizzle-kit migrate
...
const teamMembersData: schema.NewTeamMember[] = [
  {
    id: 'user-1',
...
db.insert(schema.teamMembers).values(teamMembersData).run()
...
db.insert(schema.projects).values(projectsData).run()

// Seed sprints
console.log('  Seeding sprints...')
const sprintsData: schema.NewSprint[] = [
  {
    id: 'SPRINT-1',
...
db.insert(schema.sprints).values(sprintsData).run()

// Seed issues
console.log('  Seeding issues...')
const issuesData: schema.NewIssue[] = [
  {
    id: 'POWL-96',
  ...
  {
    id: 'POWL-98',
    title: 'Liste des éléments dans le SAC',
    status: 'done',
    priority: 'medium',
    createdAt: '2024-11-14',
    updatedAt: '2024-11-14',
  ...
  {
    id: 'POWL-111',
    title: 'Refactoring composants UI',
    status: 'progress',
    priority: 'high',
    assignees: ['jean.martin'],
  ...
  {
    id: 'POWL-116',
    title: 'Design système couleurs',
    status: 'done',
    priority: 'low',
    assignees: ['hugo.moreau'],
    labels: ['design', 'ui'],
    createdAt: '2024-11-15',
    updatedAt: '2024-11-15',
  },
  ...
  },
  {
    ...
    status: 'progress',
    priority: 'medium',
    assignees: ['lea.laurent'],
    labels: ['notifications', 'mobile'],
    createdAt: '2024-11-15',
    updatedAt: '2024-11-15',
  },
  {
    id: 'POWL-119',
    title: 'Export données CSV',
    status: 'done',
    priority: 'low',
    assignees: ['thomas.garcia'],
  ...
  },
  {
    ...
    status: 'progress',
    priority: 'high',
    assignees: ['nicolas.henry'],
    labels: ['monitoring', 'observability'],
    createdAt: '2024-11-15',
    updatedAt: '2024-11-15',
  },
]
db.insert(schema.issues).values(issuesData).run()

// Seed issue relationships
console.log('  Seeding issue relationships...')
const relationshipsData = [
  {
    id: 'rel-1',
    sourceIssueId: 'POWL-96',
    targetIssueId: 'POWL-101',
    type: 'parent' as const,
  },
  {
    id: 'rel-2',
    sourceIssueId: 'POWL-96',
    targetIssueId: 'POWL-100',
    type: 'parent' as const,
  },
  {
    id: 'rel-3',
    sourceIssueId: 'POWL-101',
    targetIssueId: 'POWL-100',
    type: 'blocked_by' as const,
  },
]
db.insert(schema.issueRelationships).values(relationshipsData).run()

// Seed updates
console.log('  Seeding updates...')
const updatesData: schema.NewUpdate[] = [
  {
    id: 'update-1',
    type: 'review',
...
db.insert(schema.updates).values(updatesData).run()
