...
import { Plus, Calendar, Play, Pause, CheckCircle2, Clock, Database, RefreshCw } from "lucide-react";
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right text-sm">
                      ...
                      {sprint.status === "active" && (
                        <div className={daysRemaining < 3 ? "text-destructive font-medium" : "text-muted-foreground"}>
                          {daysRemaining > 0 ? `${daysRemaining} jours restants` : "Terminé aujourd'hui"}
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm">Voir le backlog</Button>
