...
export const Route = createFileRoute('/provider/github/')({
  component: Component,
})

function Component() {
  const provider = useGitProvider('github')
  ...
  const handleConnect = () => {
    ...
    // On connecte sans repo spécifique pour pouvoir lister les repos
        ...
        return (
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" asChild>
              <Link to={`/provider/github/${owner}/${repoName}`}>Ouvrir</Link>
            </Button>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <TokenHelpDialog provider="github" />
            </CardTitle>
            <CardDescription>
              Connectez votre compte GitHub pour lister vos repositories
            </CardDescription>
          </CardHeader>
    ...
    <div className="flex-1 p-8 overflow-auto">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Repositories GitHub</h1>
            <p className="text-muted-foreground mt-1">
              Sélectionnez un repository pour voir ses issues, PRs et workflows
            </p>
          </div>
          <div className="flex gap-2">
            <Button
        ...
        <DataTable
          ...
          data={repositories}
          searchKey="fullName"
          searchPlaceholder="Rechercher un repository..."
          loading={loading}
        />
      </div>
    </div>
    ...
    return (
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>Créer un Personal Access Token GitHub</DialogTitle>
            <DialogDescription>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium">
                    Allez dans les settings GitHub
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Visitez{' '}
                    <a
                    ...
                    et cliquez sur "Generate new token (classic)".
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground mt-1 space-y-1">
                    ...
                    <li>• Sélectionnez une expiration raisonnable</li>
