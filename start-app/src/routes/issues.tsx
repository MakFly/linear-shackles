...
import { Star, MoreHorizontal, Search, SlidersHorizontal, Bell, Link2, LayoutGrid, Keyboard, List, Columns, Calendar, Table2 } from "lucide-react";
...
import { Issue, IssueTemplate, FilterConfig, IssueStatus, Automation, Sprint } from "@/types/issue";
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
